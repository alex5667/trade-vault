...
def compute_obi_flags(
    *,
    ...
    ttl_ms = _i(cfg.get("obi_event_ttl_ms", 15000), 15000)  # default aligned with strategy.py
    ...
    if obi_dir and obi_dir == str(direction).upper():
        ...
        obi_min = _f(cfg.get("obi_stable_min_secs", 1.5), 1.5)
...
def compute_ofi_flags(
    *,
    ...
    ofi_stable = bool(ofi_dir_ok and stable_secs >= min_secs and stab >= stab_min and ev_stable == 1)
