...
STREAM_MAPPING: dict = {
    ...
    # Screener signal streams (used by SignalExporter)
    "top:losers": "stream:top-losers",
    "top:gainers": "stream:top-gainers",
    "signal:volume": "stream:volume-signals",
    "signal:funding": "stream:funding-signals",
    "signal:volatility": "stream:volatility",
    "signal:volatilityRange": "stream:volatilityRange",
}
