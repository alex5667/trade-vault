...
## Default lane
Use claude-haiku-4-5 for bounded review of one metric, one replay job, or one local test harness. Escalate to claude-opus-4-6 for methodology redesign, label changes, or ambiguous offline-vs-online discrepancies.
