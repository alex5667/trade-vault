...
APP_NAME = "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_flow_experiment_incident_rca_apply_escalations_persister_v3_57_1"
PROM = APP_NAME
REDIS_URL = os.getenv("REDIS_URL", "redis://redis-worker-1:6379/0")
PG_DSN = os.getenv("TIMESCALE_DSN", os.getenv("DATABASE_URL", ""))
METRICS_PORT = int(os.getenv("ML_ROUTE_INCIDENT_RCA_APPLY_ESCALATIONS_PERSISTER_PORT", "9997"))
POLL_BLOCK_MS = int(os.getenv("ML_ROUTE_INCIDENT_RCA_APPLY_ESCALATIONS_PERSISTER_BLOCK_MS", "15000"))
...
DLQ_STREAM = "stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_flow_experiment_incident_rca_apply_escalations_dlq"
AUDIT_STREAM = "stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_flow_experiment_incident_rca_apply_escalations_persist_audit"
GROUP = "cg:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_flow_experiment_incident_rca_apply_escalations_persister_v3_57_1"
CONSUMER = os.getenv("HOSTNAME", "incident-rca-apply-escalations-persister-v3-57-1")
...
def normalize(row: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "escalation_json": json.dumps(base, ensure_ascii=False, sort_keys=True),
    }
                    ...
                    for msg_id, fields in items:
                        ...
                        try:
                            if parsed["ts_ms"] <= 0 or parsed["decision"] == "":
                                raise ValueError("bad_escalation_payload")
