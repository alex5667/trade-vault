...
## Default lane
Use Gemini Flash for bounded edits to one retention setting or one dataset policy. Escalate to a premium reasoning model when retention affects replay trust, investigations, or multiple storage layers at once.
