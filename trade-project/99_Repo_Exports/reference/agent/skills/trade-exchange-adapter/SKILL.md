...
## Default lane
Use Gemini Flash for bounded fixes in one adapter or one payload shape. Escalate to a premium reasoning model for onboarding a new venue, redesigning normalization, or any change that may affect contracts across services.
