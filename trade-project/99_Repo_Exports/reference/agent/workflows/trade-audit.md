...
When the user types `/trade-audit <scope>` or asks for a comprehensive trade-system review, orchestrate the audit using `.agent/agents.md` and the relevant skills in `.agent/skills/`.
