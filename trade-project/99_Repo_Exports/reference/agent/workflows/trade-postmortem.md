...
When the user types `/trade-postmortem <incident>` or asks to investigate a regression, outage, bad signals, data corruption, or unexpected trading behavior, orchestrate an incident analysis using `.agent/agents.md` and `.agent/skills/`.
