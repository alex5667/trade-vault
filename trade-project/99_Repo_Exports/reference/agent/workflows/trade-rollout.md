...
When the user types `/trade-rollout <change>` or asks how to safely deploy a production-affecting trade change, orchestrate the rollout plan using `.agent/agents.md` and `.agent/skills/`.
