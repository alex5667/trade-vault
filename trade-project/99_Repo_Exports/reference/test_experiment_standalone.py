#!/usr/bin/env python3
"""
Standalone test script for experiment layer components.

Tests individual components without full handler imports.
"""
...
# Import experiment components directly
from experiment_manager import ExperimentManager, ExperimentSpec
from experiment_metrics import calculate_experiment_metrics
...
def test_experiment_manager():
    ...
    # Mock the entire psycopg2 module
    with patch('experiment_manager.psycopg2') as mock_psycopg2:
        ...
        mock_cursor.fetchall.return_value = [
            {
                ...
                "direction": 0,
                "status": "running",
                "start_at_ms": int(time.time() * 1000) - 3600000,  # 1 hour ago
                "end_at_ms": None,
        ...
        mock_cursor.fetchall.return_value = [
            {
                ...
                "direction": 0,
                "status": "running",
                "start_at_ms": int(time.time() * 1000) - 3600000,
                "end_at_ms": None,
                "target_metric": "expectancy_r",
                "config": {}
            }
