...
def main():
    """Main entry point."""
    print(f"🏷️  Telegram Callback Labeler starting...")
        ...
        for stream, entries in msgs or []:
            for msg_id, fields in entries:
                try:
                    ...
                    ts_action = int(fields.get("timestamp") or time.time() * 1000)
                    ...
                    user_id = str(fields.get("user_id") or "telegram_unknown")
                    ...
                    r.xadd(LABELS_STREAM, record, maxlen=50000)
