...
class TickProcessor:
    ...
    def _calculate_levels(
        ...
        if str(cfg.get("stop_mode", "ATR")).upper() == "ATR":
            stop_dist = atr_target * cfg.get("stop_atr_mult", 0.6)
            ...
            try:
                ...
                if calib_dist is not None:
                    try:
                        ...
                        if calib_mult > 0:
                            stop_dist = atr_target * calib_mult
                    except ValueError:
                        pass
            except Exception:
                pass
        ...
        if side.upper() == "LONG":
            ...
            tp1_dist = max(tp1_dist_base, stop_dist * 0.6) if is_rocket_v1 else tp1_dist_base
