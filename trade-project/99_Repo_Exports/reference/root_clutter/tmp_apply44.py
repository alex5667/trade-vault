...
# Phase 3.44 SQL
sql_fragment_path = 'orderflow_services/sql/ml_phase3_44_route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_flow_rca_bridge_v1.sql'
with open(sql_fragment_path, 'r', encoding='utf-8') as f:
    sql_fragment = f.read()

init_postgres_path = 'init-postgres.sql'
if sql_fragment not in open(init_postgres_path).read():
    with open(init_postgres_path, 'a', encoding='utf-8') as f:
        f.write("\n" + sql_fragment + "\n")

# Phase 3.44 Compose
compose_fragment_path = 'orderflow_services/docker_compose_fragment_ml_phase3_44_route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_flow_rca_bridge_v1.yml'
