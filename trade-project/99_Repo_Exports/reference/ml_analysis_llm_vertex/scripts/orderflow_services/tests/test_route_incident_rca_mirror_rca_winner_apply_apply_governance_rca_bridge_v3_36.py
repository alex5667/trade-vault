from orderflow_services.route_incident_rca_mirror_rca_winner_apply_apply_governance_bundle_rca_bridge_v3_36 import (
    build_local_request,
...
def _bundle():
    return {
        "bundle_id": "winner-apply-apply-governance-bundle:rollback:1",
...
def test_build_requests_have_expected_shape():
    ...
    assert vertex_req["task_family"] == "route_incident_rca_mirror_rca_winner_apply_apply_governance_rca"
