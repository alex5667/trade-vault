...
PORT = int(os.getenv("ML_OPERATOR_ROUTING_INCIDENT_ROUTE_RCA_EXPERIMENT_ROUTER_PORT", "9907"))

IN_STREAM = "stream:ml:operator_routing_incident_route_rca_routing_decisions"
OUT_STREAM = "stream:ml:operator_routing_incident_route_rca_requests_experimented"
EXPOSURE_STREAM = "stream:ml:operator_routing_incident_route_rca_exposures"

GROUP = "operator_routing_incident_route_rca_experiment_router_v2_22"
...
RUNS = _counter("ml_operator_routing_incident_route_rca_experiment_router_runs_total", "Runs", ("status",))
LAT = _hist("ml_operator_routing_incident_route_rca_experiment_router_latency_seconds", "Latency")
...
async def run_loop(r: Any) -> None:
    ...
    status = "ok"
    try:
        if os.getenv("ML_OPERATOR_ROUTING_INCIDENT_ROUTE_RCA_EXPERIMENT_ENABLE", "0") != "1":
        ...
        exp_id = os.getenv("ML_OPERATOR_ROUTING_INCIDENT_ROUTE_RCA_EXPERIMENT_ID", "route_incident_rca_ab_v1")
