...
description: Fast workflow for counting virtual trades in the last 60 minutes using a pinned canonical source only. Use claude-haiku-4-5 / Fast mode. Do not scan the repository broadly. Fail fast if the canonical source is unavailable.
---
