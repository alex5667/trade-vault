...
BINANCE_STREAMS: list = os.getenv(
    "BINANCE_STREAMS",
    f"stream:ticker-24h,stream:funding-rates,{RS.WS_NEW_PAIRS_STREAM}",
).split(",")
...
PG_DSN: str = os.getenv("ANALYTICS_DB_DSN") or os.getenv("PG_DSN") or "postgresql://user:pass@localhost:5432/trade"
