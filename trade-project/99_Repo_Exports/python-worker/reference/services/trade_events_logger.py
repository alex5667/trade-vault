...
class TradeEventsLogger:
    ...
    def log_trailing_move(self, sid: str, symbol: str, new_sl: float, current_price: float | None = None, profile: str = "unknown", position_id: str | None = None, source: str = "tp1_trailing_orchestrator", distance_from_entry: float | None = None, atr: float | None = None) -> str:
        metadata = {}
    ...
    def log_trailing_started(self, sid: str, symbol: str, profile: str, initial_sl: float | None = None, tp1_price: float | None = None, position_id: str | None = None, source: str = "tp1_trailing_orchestrator") -> str:
        metadata = {}
