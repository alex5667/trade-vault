...
class ABWinnerSuggesterService:
    ...
    def __init__(self):
        ...
        self.stream_name = os.getenv("AB_EVENTS_STREAM", RS.EVENTS_TRADES)
    ...
    def _parse_event(self, msg_id: str, data: dict[str, Any]) -> None:
        try:
            ...
            etype = (data.get("event_type", "")).upper()
            ...
            # Extract keys
            group = (meta.get("ab_group") or "default")
            regime = (meta.get("regime") or "na")
            arm = (meta.get("ab_arm") or "A").upper()
