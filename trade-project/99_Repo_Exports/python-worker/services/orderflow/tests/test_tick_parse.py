...
class TestTickParse(unittest.TestCase):
    ...
    def test_side_from_is_buyer_maker_true(self):
        ...
        self.assertEqual(tick["side"], "SELL")  # type: ignore
        self.assertEqual(tick["is_buyer_maker"], True)  # type: ignore
    ...
    def test_side_from_is_buyer_maker_false(self):
        ...
        self.assertEqual(tick["side"], "BUY")  # type: ignore
        self.assertEqual(tick["is_buyer_maker"], False)  # type: ignore
    ...
    def test_side_unknown_when_no_hints(self):
        ...
        self.assertEqual(tick["side"], "UNKNOWN")  # type: ignore
        self.assertIsNone(tick.get("is_buyer_maker"))  # type: ignore
    ...
    def test_side_explicit_buy(self):
        ...
        self.assertIsNone(tick["is_buyer_maker"])  # type: ignore
    ...
    def test_binance_m_flag(self):
        ...
        self.assertEqual(tick["side"], "SELL")   # m=True => taker SELL  # type: ignore
        self.assertEqual(tick["is_buyer_maker"], True)  # type: ignore
    ...
    def test_trade_id_extraction(self):
        ...
        for field, tid in cases:
            with self.subTest(field=field, tid=tid):
                ...
                self.assertEqual(tick["trade_id"], tid)  # type: ignore
                self.assertEqual(tick["tick_uid"], f"BTCUSDT:{tid}")  # type: ignore
    ...
    def test_tick_uid_deterministic(self):
        ...
        self.assertEqual(tick1["tick_uid"], tick2["tick_uid"])  # type: ignore
        self.assertEqual(tick1["tick_uid"], "BTCUSDT:12345")  # type: ignore
    ...
    def test_tick_uid_without_trade_id(self):
        ...
        self.assertTrue(tick["tick_uid"].startswith("BTCUSDT:h"), f"Got: {tick['tick_uid']!r}")  # type: ignore
    ...
    def test_tick_uid_different_for_different_ticks(self):
        ...
        self.assertNotEqual(tick1["tick_uid"], tick2["tick_uid"])  # type: ignore
    ...
    def test_is_buyer_maker_bool_normalization(self):
        ...
        self.assertEqual(tick_t["is_buyer_maker"], True)  # type: ignore

        tick_f = _parse_tick_payload(
            {"symbol": "BTCUSDT", "ts_ms": 1700000000000, "qty": 0.1, "is_buyer_maker": 0}
        )
        self.assertEqual(tick_f["is_buyer_maker"], False)  # type: ignore
    ...
    def test_is_buyer_maker_string_normalization(self):
        ...
        for val in ["1", "true", "yes", "on"]:
            ...
            self.assertEqual(tick["is_buyer_maker"], True, f"Expected True for {val!r}")  # type: ignore

        for val in ["0", "false", "no", "off"]:
            tick = _parse_tick_payload(
                {"symbol": "BTCUSDT", "ts_ms": 1700000000000, "qty": 0.1, "is_buyer_maker": val}
            )
            self.assertEqual(tick["is_buyer_maker"], False, f"Expected False for {val!r}")  # type: ignore
    ...
    def test_event_ts_ms_priority(self):
        ...
        self.assertEqual(tick["ts_ms"], 1700000001000)  # type: ignore
    ...
    def test_nested_data_field(self):
        ...
        self.assertIsNotNone(tick)
        self.assertEqual(tick["ts_ms"], 1700000000000)  # type: ignore
        self.assertEqual(tick["price"], 50000.0)  # type: ignore
        self.assertEqual(tick["side"], "BUY")  # type: ignore
    ...
    def test_parse_tick_payload_binance_aggtrade_like(self):
        ...
        self.assertIsNotNone(tick)
        self.assertEqual(tick["symbol"], "BTCUSDT")  # type: ignore
        self.assertEqual(tick["ts_ms"], 1700000000123)  # type: ignore
        self.assertEqual(tick["trade_id"], 12345)  # type: ignore
        self.assertEqual(tick["is_buyer_maker"], True)  # type: ignore
        self.assertEqual(tick["side"], "SELL")   # isBuyerMaker=True => taker SELL  # type: ignore
        self.assertEqual(tick["tick_uid"], "BTCUSDT:12345")  # type: ignore
    ...
    def test_parse_tick_payload_fallback_hash_uid_is_stable(self):
        ...
        self.assertIsNone(a["trade_id"])  # type: ignore
        # Fallback format: ETHUSDT:hXXXXXXXX
        self.assertTrue(a["tick_uid"].startswith("ETHUSDT:h"), f"Got: {a['tick_uid']!r}")  # type: ignore
        self.assertEqual(a["tick_uid"], b["tick_uid"])  # type: ignore
