...
def find_latest_diff(out_dir: str = "/var/lib/trade/of_reports/out") -> tuple[str, str | None, str | None] | None:
...
def check_code_changes(since_days: int = 7, paths: list[str] | None = None) -> dict[str, Any]:
...
def analyze_scenario_reason_mismatches(diff: dict[str, Any], baseline_path: str | None = None, candidate_path: str | None = None) -> dict[str, Any]:
...
def _extract_mismatch_samples(baseline_path: str, candidate_path: str, max_samples: int = 20,
                               focus_fields: list[str] | None = None) -> list[dict[str, Any]]:
