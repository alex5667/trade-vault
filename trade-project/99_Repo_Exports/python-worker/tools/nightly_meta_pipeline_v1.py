...
def main() -> int:
    ...
    if args.build_dataset:
        ...
        n_can = 0
        with open(inputs_raw, encoding="utf-8") as f_in, open(inputs_can, "w", encoding="utf-8") as f_out:
            for line in f_in:
    ...
    if args.apply_ramp:
        ...
        if os.environ.get("META_RAMP_CONTROLLED", "0") == "1" and _module_exists("meta_ramp_apply_v3.py"):
