...
class TestMetaGuardIntegration(unittest.TestCase):
    ...
    def test_engine_respects_freeze(self):
        ...
        self.assertEqual(evidence[MetaKeys.VETO], 1)
        self.assertEqual(evidence[MetaKeys.REASON], "meta_guard_freeze")
    ...
    def test_engine_respects_caps(self):
        ...
        self.assertEqual(evidence[MetaKeys.AB_SHARE], 0.0)
        # meta_enforce_share should be capped at 0.0 from 1.0
        self.assertEqual(evidence[MetaKeys.ENFORCE_SHARE], 0.0)
