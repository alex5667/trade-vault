...
APP_NAME = "route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller_v3_40"
...
AUDIT_STREAM = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_AUDIT_STREAM",
    "stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller_audit",
)
LAST_HASH = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_LAST_HASH",
    "metrics:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller:last",
)
GLOBAL_POLICY_KEY = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_GLOBAL_POLICY_KEY",
    "cfg:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller:global",
)
...
GROUP = os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_GROUP", APP_NAME)
CONSUMER = os.getenv("HOSTNAME", APP_NAME)
PORT = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_PORT", "9968"))
MAXLEN = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_MAXLEN", "20000"))

DEFAULT_ADVISORY_ONLY = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_ADVISORY_ONLY", "1"))
DEFAULT_EXECUTOR_MODE = os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_EXECUTOR_MODE", "DRY_RUN").upper()
DEFAULT_APPLY_STRATEGY = os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_STRATEGY", "SHADOW_PRIMARY").upper()
DEFAULT_COOLDOWN_SEC = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_COOLDOWN_SEC", "21600"))
DEFAULT_MIN_WINNER_SCORE = float(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_MIN_WINNER_SCORE", "0.0"))
DEFAULT_ALLOW_ARMS_JSON = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_ALLOW_ARMS_JSON",
...
RUNS = _counter(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller_runs_total",
    "Winner-apply apply governance apply-controller runs",
    ("status", "decision"),
)
LAT = _hist(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller_latency_seconds",
    "Winner-apply apply governance apply-controller latency seconds",
)
UP = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller_up",
    "Winner-apply apply governance apply-controller up",
)
LAST_RUN_TS = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller_last_run_ts_seconds",
    "Winner-apply apply governance apply-controller last run timestamp",
)
TRANSITIONS = _counter(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller_transitions_total",
    "Winner-apply apply governance apply-controller transitions",
    ("apply_strategy", "winner_arm"),
)
CURRENT_MODE = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller_current_mode",
    "Winner-apply apply governance apply-controller current experiment mode",
    ("mode",),
)
CURRENT_PRIMARY_ARM = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_apply_controller_current_primary_arm",
    "Winner-apply apply governance apply-controller current primary arm",
    ("arm",),
)
            ...
            for msg_id, payload in messages:
                ...
                try:
                    ...
                    await r.xadd(
                        AUDIT_STREAM,
                        {
                            "event_type": "ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_DECIDED",
                            **out,
                        }, maxlen=MAXLEN,
                        approximate=True,
                    )
                    ...
                    await r.xadd(
                        AUDIT_STREAM,
                        {
                            "event_type": "ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_APPLY_CONTROLLER_FAILED",
                            "error": str(exc),
                            "ts_ms": str(now_ms()),
                        }, maxlen=MAXLEN,
                        approximate=True,
