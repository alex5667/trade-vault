...
def main() -> None:
    ...
    ap.add_argument("--redis-url", required=True, help="e.g. redis://localhost:6379/0")
    ...
    ap.add_argument("--max-records", type=int, default=0, help="0 means unlimited")
    ap.add_argument("--state-file", default=os.getenv("OF_INPUTS_STATE_FILE", ""))
    ap.add_argument("--resume", action="store_true", help="resume from last id in state-file")
    ap.add_argument("--no-validate", action="store_true", help="do not json-validate payload")
