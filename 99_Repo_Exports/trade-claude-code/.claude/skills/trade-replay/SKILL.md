...
When the user types `/trade-replay <scope>` or asks for replay, baseline diffing, dataset export, regression checks, or offline validation, orchestrate the work using `.claude/agents/agents.md` and `.claude/skills/`.
