...
## Default lane
Use a premium reasoning model when the task changes entry policy, exit policy, fill assumptions, or rollout approval. Use Gemini Flash only for bounded metric collection or local config edits.
