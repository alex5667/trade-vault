...
def _normalize_row(evt: dict[str, Any]) -> tuple[dict[str, Any] | None, str]:
    ...
    row = {
        ...
        "sid": sid,
        "symbol": symbol,
        "model_ver": str(evt.get("model_ver") or evt.get("model_version") or evt.get("meta_model_ver") or evt.get("meta_model_version") or ""),
        "mode": (evt.get("mode") or evt.get("meta_mode") or ""),
        "p_edge": _to_float(evt.get("p_edge") or evt.get("meta_p_edge") or evt.get("final_score")),
        "p_min": _to_float(evt.get("p_min") or evt.get("meta_p_min")),
        "p_margin": _to_float(evt.get("p_margin") or evt.get("meta_p_margin")),
