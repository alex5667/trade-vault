...
class SignalBridgeDispatcher:
    ...
    def __init__(self, *, mode: str):
        ...
        self.bridge_notify_stream = os.getenv("SIGNAL_BRIDGE_NOTIFY_STREAM", "stream:signals:bridge:notify")
        self.bridge_manual_stream = os.getenv("SIGNAL_BRIDGE_MANUAL_STREAM", "stream:signals:bridge:manual")

        self.target_notify_stream = os.getenv("NOTIFY_STREAM", "notify:telegram")
