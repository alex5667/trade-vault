...
class MLConfirmGate:
    ...
    def _emit_metrics(self, dec: MLConfirmDecision, *, symbol: str, ts_ms: int, direction: str, scenario: str,
        ...
        try:
            ...
            redis.xadd(self._metrics_stream, payload, maxlen=50000, approximate=True)
        except Exception as e:
    ...
    def check(
        ...
        *,
        ...
        if self.mode == "OFF":
            ...
            if METRICS_REGISTRY_AVAILABLE:
                self._metrics_events_total.labels(kind="none", outcome="OFF").inc()
        ...
        if not self._cfg:
            ...
            if METRICS_REGISTRY_AVAILABLE:
                self._metrics_events_total.labels(kind=kind_for_metrics, outcome="ERR").inc()
