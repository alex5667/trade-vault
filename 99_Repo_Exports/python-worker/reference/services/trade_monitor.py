        ...
        *,
        ...
        for key, value in os.environ.items():
            if key.startswith("MIN_SIGNAL_CONFIDENCE__"):
                ...
                try:
                    self._symbol_conf_thresholds[symbol] = float(value)
            ...
            with ctx:
                ...
                with self._lock:
                    ...
                    for pos_id in by_sym.get(sym, []):
                        ...
                        local_triggers.append((mapped_src, str(getattr(pos, "symbol", "")), str(pos.id)))
        ...
        with sym_ctx:
            ...
            for pos in pos_list:
                ...
                if closed:
                    ...
                    from domain.normalizers import source_from_strategy
                    mapped_src = source_from_strategy(getattr(pos, "strategy", ""), str(getattr(pos, "source", "")))
                    report_triggers.append((mapped_src, pos.symbol, pos.id))
