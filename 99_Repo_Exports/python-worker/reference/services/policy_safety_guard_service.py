...
class PolicySafetyGuard:
    def __init__(self) -> None:
        ...
        self.notify_stream = os.getenv("TELEGRAM_NOTIFY_STREAM", "stream:notify:telegram")
    ...
    def _notify(self, text: str) -> None:
        try:
            ...
            self.r.xadd(self.notify_stream, msg, maxlen=int(os.getenv("TELEGRAM_NOTIFY_STREAM_MAXLEN", "20000")), approximate=True)
        except Exception:
            pass
