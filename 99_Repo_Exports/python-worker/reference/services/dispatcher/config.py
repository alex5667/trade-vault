...
class SignalDispatcherConfig:
    ...
    def __init__(self):
        ...
        try:
            # Support both CRYPTO_NOTIFY_SIGNAL_EVERY_N and NOTIFY_SIGNAL_EVERY_N
            # Priority: CRYPTO_NOTIFY_SIGNAL_EVERY_N > NOTIFY_SIGNAL_EVERY_N > default=1
            every_n_str = os.getenv("CRYPTO_NOTIFY_SIGNAL_EVERY_N", os.getenv("NOTIFY_SIGNAL_EVERY_N", "1"))
        ...
        self.manual_stream = os.getenv("SIGNAL_MANUAL_STREAM", "stream:signals:manual")
