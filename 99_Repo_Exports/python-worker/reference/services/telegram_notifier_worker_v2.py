...
NOTIFY_TELEGRAM_CHAT_ID_CRIT = os.getenv("NOTIFY_TELEGRAM_CHAT_ID_CRIT", TELEGRAM_CHAT_ID)
NOTIFY_TELEGRAM_CHAT_ID_PAGE = os.getenv("NOTIFY_TELEGRAM_CHAT_ID_PAGE", TELEGRAM_CHAT_ID)
...
def process_message(r, stream_key, message_id, message_data):
    ...
    try:
        ...
        # Determine target chat ID based on stream or payload override
        chat_id = TELEGRAM_CHAT_ID
        severity = "info"
        
        if stream_key == "notify:telegram:crit":
            chat_id = NOTIFY_TELEGRAM_CHAT_ID_CRIT
            severity = "crit"
        elif stream_key == "notify:telegram:page":
