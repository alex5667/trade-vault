...
Intended usage inside any ApplyRunner / auto-apply entrypoint:
    ...
    from orderflow_services.auto_apply_guard import assert_auto_apply_not_blocked
...
# P110: OFInputs V3 block-key prefixes (global and per-symbol)
...
# P110: expanded default reasons — includes of_inputs_exporters_smoke (P109) and of_inputs_v3 (P100)
...
def get_block_state(
    ...
    # P110: use DEFAULT_REASONS instead of hardcoded "tick_gate"
    ...
    # P110: read V3 prefix overrides from env
    ...
    for rsn in reasons:
        ...
        # v3 global hard block (preferred over legacy)
