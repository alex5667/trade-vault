...
class ConfidenceThresholdConfig:
    ...
    def from_env(cls) -> ConfidenceThresholdConfig:
        ...
        min_conf_default = float(os.getenv("MIN_CONF_DEFAULT", "70.0"))
...
class ConfidenceThresholdFilter:
    ...
    def evaluate(
        ...
        # Санитизируем входы (fail-open при отсутствии данных)
        conf_pct = safe_float(confidence_pct, min_conf_pct + 1.0)  # Pass если отсутствует
        conf_fac = safe_float(conf_factor, min_conf_factor + 0.01)  # Pass если отсутствует
