...
def main():
    ...
    logger.info(f"Building OFC Contextual Dataset...")
    ...
    try:
        ...
        logger.info(f"Training Exec Cost Model...")
        ...
        logger.info(f"Training Rule Success Model...")
        ...
        logger.info(f"Building and Promoting Contextual Bundle...")
