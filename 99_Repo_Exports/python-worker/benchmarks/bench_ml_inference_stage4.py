...
from services.ml_confirm_gate import MLConfirmGate, MLConfirmDecision, _safe_loads, _load_model_cached
...
def benchmark_ml_gate_check():
    ...
    from services.ml_confirm_gate import _safe_loads, _load_model_cached
