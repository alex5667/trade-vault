...
def main():
    ...
    raw_entries = r.xrevrange(RS.CRYPTO_RAW, max="+", min="-", count=3)
    if raw_entries:
    ...
    telegram_entries = r.xrevrange(RS.NOTIFY_TELEGRAM, max="+", min="-", count=10)
    ...
    counter = r.get(RS.NOTIFY_SIGNAL_COUNTER)
    ...
    if counter:
        ...
        if remainder != 0:
            ...
            print("   ✅ Следующий сигнал пройдет в Telegram")
