...
class SymbolRuntime:
    ...
    last_lob_event: Optional[Dict[str, Any]] = None
    ...
    trail_calib_params: Optional[Dict[str, Any]] = None
    ...
    async def ensure_specs_fresh(self, r) -> None:
        ...
        try:
            ...
            try:
                ...
                if _trail_raw and str(_trail_raw.get("mode", "shadow")) == "enforce":
            ...
            try:
                ...
                if tf:
                    try:
                        self.dynamic_cfg[DK.TAKER_FLOW_GATE_ENFORCE_BUCKETS] = str(tf)
                    except Exception:
                        pass
                    try:
                        if isinstance(self.config, dict):
                            self.config["taker_flow_gate_enforce_buckets"] = str(tf)
                    except Exception:
                        pass
            except Exception:
                pass
