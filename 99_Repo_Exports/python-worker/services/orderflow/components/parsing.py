...
class OrderFlowParsing:
    ...
    @staticmethod
    def parse_tick_payload(raw_data: Any, default_symbol: str = "", log: Optional[Callable] = None) -> Optional[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def parse_book_payload(raw_data: Any, symbol: str) -> Optional[Dict[str, Any]]:
        """
