...
ATR_REPLAY_CERT_ENABLE = os.getenv("ATR_REPLAY_CERT_ENABLE", "1") == str("1")
ATR_REPLAY_CERT_ENFORCE = os.getenv("ATR_REPLAY_CERT_ENFORCE", "0") == str("1")
...
class ATRReplayCertificationService:
    ...
    @staticmethod
    def compare_replay_outputs(baseline_ref: str, candidate_ref: str, defect: Optional[str] = None) -> List[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def _load_replay_ref(ref: str) -> Tuple[List[Dict[str, Any]], Optional[str]]:
        if not ref:
            return [], "empty_ref"
    ...
    @classmethod
    def run_replay_certification(cls, change_id: str, change_class: str, baseline_ref: str, candidate_ref: str, defect: Optional[str] = None) -> List[str]:
    ...
    @staticmethod
    def get_cert_status_for_change(change_id: str, change_class: str) -> Optional[str]:
        required_classes = ATRReplayCertificationService.classify_datasets_for_change(change_class)
