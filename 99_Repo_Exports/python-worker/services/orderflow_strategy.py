...
from services.orderflow.metrics import (
    ...
    book_stale_ms_gauge, ptier_tier0_usd, ptier_tier1_usd, ptier_tier2_usd, dn_gate_events_total, of_session_outcome_total, veto_low_conf_total, cvd_reclaim_eval_total, cvd_reclaim_ok_total, cvd_reclaim_applied_total, cvd_reclaim_age_ms_gauge, record_confirmation_seen, record_evidence_used, g4_canary_veto_total
)
...
class OrderFlowStrategy:
    ...
    async def process_tick(self, runtime: SymbolRuntime, tick: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if is_veto == 1:
                dh_mode = str(cfg.get("data_health_veto_mode", os.getenv("DATA_HEALTH_VETO_MODE", "canary"))).lower()
