    ...
    def check(
        ...
        *,
        ...
        try:
            ...
            if bucket_id is not None:
                try:
                    ...
                    if st.last_bucket_id is not None and b <= st.last_bucket_id:
                        return GateDecision(allow=True, reason="cancel_spike_duplicate_bucket", meta={"bucket_id": b, "mode": p.mode})
                    st.last_bucket_id = b
                except Exception:
                    pass
            ...
            # hard fail-open
            return GateDecision(allow=True, reason="cancel_spike_error_fail_open", meta={})
