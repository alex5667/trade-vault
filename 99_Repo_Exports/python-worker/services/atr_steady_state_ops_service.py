...
def main():
    ops_enable = str(os.getenv("ATR_STEADY_STATE_OPS_ENABLE", "1")).lower() in ("1", "true", "yes")
    daily_enable = str(os.getenv("ATR_STEADY_STATE_DAILY_SCORECARD_ENABLE", "1")).lower() in ("1", "true", "yes")
    weekly_enable = str(os.getenv("ATR_STEADY_STATE_WEEKLY_SCORECARD_ENABLE", "1")).lower() in ("1", "true", "yes")
    monthly_dr_enable = str(os.getenv("ATR_STEADY_STATE_MONTHLY_DR_ENABLE", "1")).lower() in ("1", "true", "yes")
    enforce_windows = str(os.getenv("ATR_STEADY_STATE_ENFORCE_RELEASE_WINDOWS", "1")).lower() in ("1", "true", "yes")
