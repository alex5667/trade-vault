...
APP_NAME = "route_incident_rca_mirror_rca_winner_apply_apply_evaluator_v3_31"
...
RESULT_STREAMS_JSON = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_RESULT_STREAMS_JSON",
    '["stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_rca_results","stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_vertex_rca_results","stream:ml:local_fallback_results"]',
)
FEEDBACK_STREAMS_JSON = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_FEEDBACK_STREAMS_JSON",
    '["stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_vertex_rca_feedback"]',
)
SCORECARDS_STREAM = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_SCORECARDS_STREAM",
...
AUDIT_STREAM = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_AUDIT_STREAM",
    "stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_evaluator_audit",
)
LAST_HASH = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_LAST_HASH",
    "metrics:ml:route_incident_rca_mirror_rca_winner_apply_apply_evaluator:last",
)
GLOBAL_POLICY_KEY = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_GLOBAL_POLICY_KEY",
    "cfg:ml:route_incident_rca_mirror_rca_winner_apply_apply_evaluator:global",
)
PORT = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_PORT", "9956"))
MAXLEN = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_MAXLEN", "20000"))
RUN_EVERY_SEC = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_RUN_EVERY_SEC", "300"))
LOOKBACK_COUNT = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_LOOKBACK_COUNT", "500"))
WINDOW_MIN = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_WINDOW_MIN", "10080"))

DEFAULT_MIN_EXPOSURES = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_MIN_EXPOSURES", "10"))
DEFAULT_MIN_FEEDBACK = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_MIN_FEEDBACK", "5"))
DEFAULT_MIN_RESULT_COVERAGE = float(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_MIN_RESULT_COVERAGE", "0.30"))
DEFAULT_MIN_FEEDBACK_COVERAGE = float(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_MIN_FEEDBACK_COVERAGE", "0.20"))
DEFAULT_MIN_QUALITY = float(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_MIN_QUALITY", "0.55"))
DEFAULT_MIN_USEFULNESS = float(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_MIN_USEFULNESS", "0.60"))
DEFAULT_MIN_ACCEPTED_RATE = float(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_MIN_ACCEPTED_RATE", "0.60"))
DEFAULT_MIN_SCORE_MARGIN = float(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_MIN_SCORE_MARGIN", "0.05"))
DEFAULT_INCUMBENT_ARM = os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_INCUMBENT_ARM", "deterministic")
DEFAULT_ADVISORY_ONLY = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_ADVISORY_ONLY", "1"))
DEFAULT_EXECUTOR_MODE = os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_EXECUTOR_MODE", "DRY_RUN").upper()
...
RUNS = _counter(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_evaluator_runs_total",
    "Winner-apply apply evaluator runs",
    ("status", "decision"),
)
LAT = _hist(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_evaluator_latency_seconds",
    "Winner-apply apply evaluator latency seconds",
)
UP = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_evaluator_up",
    "Winner-apply apply evaluator up",
)
LAST_RUN_TS = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_evaluator_last_run_ts_seconds",
    "Winner-apply apply evaluator last run timestamp",
)
ARM_SCORE = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_evaluator_arm_score",
    "Winner-apply apply evaluator arm score",
    ("arm",),
)
ARM_FEEDBACK_N = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_evaluator_arm_feedback_n",
    "Winner-apply apply evaluator arm feedback count",
    ("arm",),
)
ARM_ACCEPTED_RATE = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_evaluator_arm_accepted_rate",
    "Winner-apply apply evaluator arm accepted rate",
    ("arm",),
)
    ...
    while True:
        ...
        try:
            ...
            await r.xadd(
                AUDIT_STREAM,
                {
                    "event_type": "ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_EVALUATOR_DECIDED",
                    "decision": recommendation["decision"],
                    "reason_code": recommendation["reason_code"],
                    "winner_arm": recommendation["winner_arm"],
                    "ts_ms": str(now_ms()),
