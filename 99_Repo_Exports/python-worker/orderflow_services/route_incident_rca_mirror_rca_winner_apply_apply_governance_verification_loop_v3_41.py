...
APP_NAME = "route_incident_rca_mirror_rca_winner_apply_apply_governance_verification_loop_v3_41"
...
AUDIT_STREAM = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_AUDIT_STREAM",
    "stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_verification_audit",
)
LAST_HASH = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_LAST_HASH",
    "metrics:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_verification:last",
)
GLOBAL_POLICY_KEY = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_GLOBAL_POLICY_KEY",
    "cfg:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_verification:global",
)
...
PORT = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_PORT", "9969"))
MAXLEN = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_MAXLEN", "20000"))
RUN_EVERY_SEC = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_RUN_EVERY_SEC", "300"))
LOOKBACK_COUNT = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_LOOKBACK_COUNT", "200"))
MAX_APPLY_AGE_SEC = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_MAX_APPLY_AGE_SEC", "86400"))

DEFAULT_ADVISORY_ONLY = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_ADVISORY_ONLY", "1"))
DEFAULT_EXECUTOR_MODE = os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_EXECUTOR_MODE", "DRY_RUN").upper()
DEFAULT_MIN_EXPOSURES = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_MIN_EXPOSURES", "5"))
DEFAULT_MIN_PRIMARY_MATCH_RATE = float(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_MIN_PRIMARY_MATCH_RATE", "0.80"))
DEFAULT_MAX_UNEXPECTED_PRIMARY_RATE = float(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_MAX_UNEXPECTED_PRIMARY_RATE", "0.20"))
DEFAULT_MAX_SHADOW_RATE_SINGLE_ARM = float(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_MAX_SHADOW_RATE_SINGLE_ARM", "0.05"))
DEFAULT_REQUIRE_POLICY_MATCH = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_REQUIRE_POLICY_MATCH", "1"))
DEFAULT_ROLLBACK_COOLDOWN_SEC = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_ROLLBACK_COOLDOWN_SEC", "21600"))
...
RUNS = _counter(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_verification_runs_total",
    "Winner-apply apply governance verification runs",
    ("status", "decision"),
)
LAT = _hist(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_verification_latency_seconds",
    "Winner-apply apply governance verification latency seconds",
)
UP = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_verification_up",
    "Winner-apply apply governance verification up",
)
LAST_RUN_TS = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_verification_last_run_ts_seconds",
    "Winner-apply apply governance verification last run ts",
)
PRIMARY_MATCH_RATE = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_primary_match_rate",
    "Winner-apply apply governance primary match rate",
)
UNEXPECTED_PRIMARY_RATE = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_unexpected_primary_rate",
    "Winner-apply apply governance unexpected primary rate",
)
SHADOW_RATE = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_shadow_rate",
    "Winner-apply apply governance shadow rate",
)
ROLLBACKS = _counter(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_rollbacks_total",
    "Winner-apply apply governance rollbacks",
...
async def persist_if_configured(
    ...
    with psycopg.connect(db_url) as conn:  # pragma: no cover
        with conn.cursor() as cur:
            cur.execute(
                """
                INSERT INTO llm_governance_verification_results (
                    ts_ms,
                    decision,
                    reason_code,
                    current_mode,
            ...
            if evaluation["decision"] == "ROLLBACK_PREVIOUS_POLICY":
                cur.execute(
                    """
                    INSERT INTO llm_governance_rollback_journal (
                        ts_ms,
                        reason_code,
                        mode_before,
                        primary_arm_before,
...
async def main() -> None:  # pragma: no cover
    ...
    while True:
        ...
        try:
            ...
            await r.xadd(
                AUDIT_STREAM,
                {"event_type": "ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_DECIDED", **out},
                maxlen=MAXLEN,
                approximate=True,
            )
            await r.hset(
            ...
            await r.xadd(
                AUDIT_STREAM,
                {
                    "event_type": "ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_VERIFICATION_FAILED",
                    "error": str(exc),
                    "ts_ms": str(now_ms()),
                },
                maxlen=MAXLEN,
