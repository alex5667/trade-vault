...
APP_NAME = "route_incident_rca_mirror_rca_winner_apply_apply_governance_experiment_harness_v3_38"
...
DECISIONS_STREAM = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_DECISIONS_STREAM",
    "stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_experiment_decisions",
)
AUDIT_STREAM = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_AUDIT_STREAM",
    "stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_experiment_audit",
)
LAST_HASH = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_LAST_HASH",
    "metrics:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_experiment:last",
)
...
DETERMINISTIC_STREAM = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_DETERMINISTIC_STREAM",
...
VERTEX_CANDIDATE_STREAM = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_VERTEX_STREAM",
    "stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_vertex_rca_candidate_requests",
)
LOCAL_CANDIDATE_STREAM = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_LOCAL_STREAM",
    "stream:ml:route_incident_rca_mirror_rca_winner_apply_apply_governance_local_rca_candidate_requests",
)
GROUP = os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_GROUP", APP_NAME)
CONSUMER = os.getenv("HOSTNAME", APP_NAME)
PORT = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_PORT", "9966"))
MAXLEN = int(os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_MAXLEN", "20000"))

DEFAULT_MODE = os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_MODE", "SHADOW").upper()
DEFAULT_HASH_SALT = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_HASH_SALT",
    "route_incident_rca_mirror_rca_winner_apply_apply_governance_v3_38",
)
DEFAULT_ALLOW_SEVERITIES = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_ALLOW_SEVERITIES",
    "warning,critical",
)
DEFAULT_MAX_BUNDLE_BYTES = int(
    os.getenv("ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_MAX_BUNDLE_BYTES", "131072")
)
DEFAULT_ARM_WEIGHTS_JSON = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_ARM_WEIGHTS_JSON",
    '{"deterministic":70,"vertex_candidate":20,"local_fallback_candidate":10}',
)
DEFAULT_PRIMARY_ARM = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_PRIMARY_ARM",
    "deterministic",
)
DEFAULT_SHADOW_ARMS_JSON = os.getenv(
    "ML_ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_SHADOW_ARMS_JSON",
...
RUNS = _counter(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_experiment_runs_total",
    "Winner-apply apply governance experiment harness runs",
    ("status", "decision"),
)
LAT = _hist(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_experiment_latency_seconds",
    "Winner-apply apply governance experiment harness latency seconds",
)
UP = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_experiment_up",
    "Winner-apply apply governance experiment harness up",
)
LAST_RUN_TS = _gauge(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_experiment_last_run_ts_seconds",
    "Winner-apply apply governance experiment harness last run timestamp",
)
EXPOSURES = _counter(
    "ml_route_incident_rca_mirror_rca_winner_apply_apply_governance_exposures_total",
    "Winner-apply apply governance experiment exposures",
    ("arm", "severity", "mode"),
)
...
def build_arm_request(bundle: Dict[str, Any], arm: str, is_primary: bool) -> Dict[str, Any]:
    ...
    if arm == "deterministic":
        ...
        base["task_type"] = "route_incident_rca_mirror_rca_winner_apply_apply_governance_rca_candidate"
        base["provider_mode"] = "VERTEX_CANDIDATE"
    elif arm == "local_fallback_candidate":
        base["task_type"] = "route_incident_rca_mirror_rca_winner_apply_apply_governance_rca_local_candidate"
        ...
        for _stream, messages in rows:
            for msg_id, payload in messages:
                ...
                try:
                    ...
                    await r.xadd(
                        AUDIT_STREAM,
                        {"event_type": "ROUTE_INCIDENT_RCA_MIRROR_RCA_WINNER_APPLY_APPLY_GOVERNANCE_EXPERIMENT_DECIDED", **out},
                        maxlen=MAXLEN,
                        approximate=True,
                    )
                    await r.hset(
