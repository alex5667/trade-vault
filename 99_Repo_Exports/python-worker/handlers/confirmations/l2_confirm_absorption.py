...
class AbsorptionConfirmCfg:
    ...
    min_refill_ratio: float = 0.6
    legacy_missing_src_mult: float = 0.70
...
class L2ConfirmAbsorption:
    ...
    def confirm(
        ...
        **_: Any,
        ...
        refill_ok = bool(refill is not None and refill >= self.cfg.min_refill_ratio)
        ...
        if not require_2ofn:
            if not src_a:
                ...
                score01 *= self.cfg.legacy_missing_src_mult
            if not src_b:
