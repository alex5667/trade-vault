...
class Signal:
    ...
    source: Optional[str] = None  # OrderFlow, AggregatedHub-V2, etc
...
class Order:
    ...
    tp1_time: Optional[float] = None
    tp2_price: Optional[float] = None
    tp2_time: Optional[float] = None
    tp3_price: Optional[float] = None
    tp3_time: Optional[float] = None
    sl_price: Optional[float] = None
    sl_time: Optional[float] = None
...
class Repository:
    ...
    def read_signal(self, signal_id: str) -> Optional[Signal]:
        """
    ...
    def get_trade_events(self, order_id: str) -> List[Dict[str, Any]]:
        ...
        """
        try:
            messages = self.r.xrevrange("events:trades", count=1000)
