...
from core.feature_registry import _SCHEMA_CACHE, _EDGE_CACHE
...
def test_group_a_computers():
    from core.v11_of_computers.regime_computers import (
        compute_hurst_exp_50, compute_vol_regime_code, compute_kyle_lambda, compute_roll_spread_est
    )
...
def test_group_b_computers():
    from core.v11_of_computers.session_computers import (
        compute_kelly_fraction_roll, compute_profit_factor_roll20
    )
...
def test_group_d_computers():
    from core.v11_of_computers.microstructure_computers import (
        compute_large_trade_ratio, compute_sweep_velocity_bps_s
    )
...
def test_group_f_computers():
    from core.v11_of_computers.interaction_computers import (
        compute_kyle_x_vpin, compute_momentum_x_vol_ratio, compute_liq_score_x_spread
    )
