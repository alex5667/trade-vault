...
class TestLabelJoinerService(unittest.TestCase):
    ...
    def test_process_trade_event_success_win(self):
        ...
        # Execute
        result = self.service.process_trade_event("events:trades", "1-0", fields)
    ...
    def test_process_trade_event_loss(self):
        ...
        result = self.service.process_trade_event("events:trades", "2-0", fields)
        assert result is True
    ...
    def test_generic_event_ignored(self):
        ...
        result = self.service.process_trade_event("events:trades", "3-0", fields)
        assert result is True
    ...
    def test_decision_not_found(self):
        ...
        result = self.service.process_trade_event("events:trades", "4-0", fields)
