...
## Model lane
Default to a **claude-opus-4-6 + Planning** mode for canary/prod decisions.
For merge-only bounded changes, **claude-haiku-4-5** is acceptable if no premium trigger fires.
