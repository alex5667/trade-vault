...
def _set_profile_fields(mapping: Dict[str, Any], *, profile_value: str) -> None:
    ...
    """
    v = profile_value or ""
    mapping[CANON_PROFILE_FIELD] = v
    mapping[ALIAS_PROFILE_FIELD] = v
...
TRADES_CLOSED_STREAM_NAME = os.getenv("TRADES_CLOSED_STREAM_NAME", "trades:closed")
...
class RedisTradeRepository:
    ...
    def save_closed(self, closed, *, health_snapshot=None) -> None:
        ...
        mapping = {
            ...
            "entry_time": str(getattr(closed, "entry_ts_ms", 0) or 0),
    ...
    def append_event(self, ev: TradeEvent) -> None:
        ...
        self.r.xadd("events:trades", payload, maxlen=200000)
