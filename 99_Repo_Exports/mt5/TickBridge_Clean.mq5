...
//+------------------------------------------------------------------+
bool ParseCommentForSignal(const string comment, string &sid, double &tp1, double &tp2, double &tp3)
{
   int i;
   int cnt;
   int n;
...
//+------------------------------------------------------------------+
bool PublishTradeEvent(const string event_type, const string sid, const string symbol, ulong ticket, double price, double lot)
{
   int digits;
   int res;
   long ts_ms;
