...
When the user types `/trade-new-signal <idea>` or asks to add, improve, or refactor a detector/gate, orchestrate a production-safe signal design flow using `.agent/agents.md` and `.agent/skills/`.
