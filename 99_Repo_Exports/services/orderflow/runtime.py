...
from services.orderflow.utils import (
    ...
    _parse_tick_payload, _parse_book_payload, LogSampler, LogSamplerFactory
)
...
from core.ofi_tracker import OFIStabilityTracker, OFIEvent
...
from core.atr_sanity_guard import RangeTfAggregator, pick_best_atr, tf_to_ms
...
class SymbolRuntime:
    ...
    of_inputs_v3_disabled_phase: str = ""
    ...
    # Raw OBI snapshot (always updated on book push, even without stable event)
    last_obi_snapshot: Optional[Dict[str, Any]] = None
